const typed=new Typed('.typed',{
    strings:['<i class="inicio">Descargue el código aquí!<br>↓↓↓↓↓↓↓↓↓↓↓</i>'],
    typeSpeed: 130, // Velocidad en mlisegundos para poner una letra,
...
const typed2=new Typed('.typed2',{
    strings:['<i class="inicio">Si quiere ver la página haga click aquí<br>→→→→→→→→</i>'],
